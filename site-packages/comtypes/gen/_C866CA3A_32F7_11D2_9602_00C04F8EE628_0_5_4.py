...
__all__ = [
    'SPCT_SLEEP', 'SPAS_CLOSED', 'eLEXTYPE_USER_SHORTCUT',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SOTCEnumerateTokens',
    'SREFalseRecognition', 'SAFTGSM610_8kHzMono', 'IEnumString',
    'SpeechTokenValueCLSID', 'SpeechRecoContextState',
    'eLEXTYPE_RESERVED9', 'DISPID_SFSOpen', 'ISpPhraseAlt',
    'SAFTGSM610_44kHzMono', 'DISPID_SPEPronunciation',
    'DISPID_SpeechWaveFormatEx', 'ISpRecoContext',
    'SpeechPropertyNormalConfidenceThreshold', 'SP_VISEME_7',
    'SP_VISEME_17', 'DISPID_SpeechPhraseInfo', 'SP_VISEME_1',
    'DISPID_SRCESoundStart', 'SSTTTextBuffer', 'SRATopLevel',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SP_VISEME_3',
    'DISPID_SDKSetLongValue', 'SGRSTTWord', 'SVSFParseMask',
    'SAFT8kHz8BitMono', 'SPEI_MIN_SR', 'DISPID_SVPriority',
    'DISPID_SpeechVoiceStatus', 'SVSFIsXML', 'DISPID_SPPName',
    'DISPID_SPRuleEngineConfidence', 'SpeechGrammarState',
    'SREPropertyStringChange', 'DISPID_SPRs_NewEnum',
    'SPCT_SUB_DICTATION', 'SPVPRI_OVER', 'DISPID_SRCEEnginePrivate',
    'SECFIgnoreWidth', 'SAFTADPCM_8kHzStereo',
    'SAFTADPCM_11kHzStereo', 'SASPause', 'ISpeechPhoneConverter',
    'SVP_15', 'DISPID_SGRAddState',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SVEPrivate', 'SVPOver',
    'DISPID_SASCurrentDevicePosition', 'DISPID_SVDisplayUI',
    'Speech_StreamPos_RealTime', 'SpeechVoiceEvents',
    'ISpRecoContext2', 'SPRS_ACTIVE', 'SVEWordBoundary',
    'SAFT8kHz16BitStereo', 'SpSharedRecoContext',
    'DISPID_SLPPhoneIds', 'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SRSAudioStatus', 'SRSEDone',
    'DISPID_SPPBRestorePhraseFromMemory',
    'DISPID_SPERequiredConfidence', 'SAFTCCITT_uLaw_22kHzStereo',
    'DISPID_SpeechObjectTokenCategory', 'SPEI_TTS_AUDIO_LEVEL',
    'ISpProperties', 'SAFTDefault', 'DISPID_SPEEngineConfidence',
    'SVSFIsFilename', 'SPSFunction', 'DISPID_SRGState',
    'DISPID_SPRuleConfidence', 'SpeechCategoryRecoProfiles',
    'ISpVoice', 'DISPID_SPPsItem', 'SDKLLocalMachine',
    'DISPID_SRRSaveToMemory', 'DISPID_SpeechVoiceEvent',
    'ISpeechTextSelectionInformation', 'SVSFUnusedFlags',
    'DISPID_SLPSymbolic', 'SREAudioLevel', 'SVP_3',
    'ISpeechWaveFormatEx', 'SPEI_REQUEST_UI',
    'DISPID_SRCCmdMaxAlternates', 'SpStreamFormatConverter',
    'SAFT24kHz16BitMono', 'DISPID_SVEStreamEnd', 'ISpeechBaseStream',
    'SVP_0', 'SGDSInactive', 'DISPID_SRRAudioFormat',
    'eLEXTYPE_RESERVED7', 'SpeechWordType',
    'DISPID_SpeechXMLRecoResult', 'SAFTCCITT_uLaw_8kHzMono',
    'SpeechVoicePriority', 'DISPID_SWFEBitsPerSample',
    'DISPID_SPIElements', 'SPPS_Verb', 'SGPronounciation',
    'SPBINARYGRAMMAR', 'SPRECORESULTTIMES', 'SITooLoud',
    'DISPID_SWFEExtraData', 'SPCT_SUB_COMMAND',
    'DISPID_SPPEngineConfidence', 'SAFTCCITT_ALaw_22kHzStereo',
    'DISPID_SVGetAudioOutputs', 'SPINTERFERENCE_LATENCY_WARNING',
    'SpStream', 'DISPID_SRGCmdLoadFromMemory', 'SPFM_CREATE_ALWAYS',
    'DISPID_SVEAudioLevel', 'ISpeechFileStream', 'DISPID_SRState',
    'SpeechRegistryUserRoot', '_RemotableHandle', 'eLEXTYPE_PRIVATE1',
    'SPAUDIOBUFFERINFO', 'ISpeechGrammarRuleStateTransitions',
    'SPEI_SR_RETAINEDAUDIO', 'DISPID_SGRId', 'ISpNotifyTranslator',
    'SAFT16kHz16BitMono', 'SPEI_PHRASE_START', 'SAFT48kHz8BitMono',
    'DISPID_SGRs_NewEnum', 'SpeechCategoryPhoneConverters',
    'SVEPhoneme', 'SPRST_INACTIVE', 'SAFTCCITT_ALaw_44kHzStereo',
    'SLTApp', 'DISPID_SVGetProfiles', 'DISPID_SVEBookmark',
    'SRESoundEnd', 'DISPID_SpeechRecognizerStatus',
    'DISPID_SLWLangId', 'SpeechWordPronounceable',
    'DISPID_SVEventInterests', 'SPFILEMODE', 'SDA_One_Trailing_Space',
    'DISPID_SPISaveToMemory', 'SpeechGrammarTagDictation',
    'eLEXTYPE_PRIVATE9', 'SPEI_START_SR_STREAM', 'IStream', 'SVP_10',
    'DISPID_SRProfile', 'SVP_4', 'DISPID_SVSyncronousSpeakTimeout',
    'DISPID_SGRAttributes', 'SECNormalConfidence',
    'DISPID_SRSetPropertyNumber', 'SPEI_UNDEFINED', 'SPLEXICONTYPE',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'DISPID_SMSALineId',
    'DISPID_SPRuleName', 'eLEXTYPE_PRIVATE18', 'SPFM_OPEN_READONLY',
    'SPEI_PROPERTY_NUM_CHANGE', 'DISPID_SAStatus', 'STSF_AppData',
    'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SPRFirstElement',
    'SPXRO_Alternates_SML', 'SAFT12kHz16BitStereo', 'SPPS_Function',
    'SAFTCCITT_ALaw_44kHzMono', 'SREStateChange',
    'DISPID_SGRsCommitAndSave', 'ISpeechRecoGrammar',
    'SpeechTokenShellFolder', 'SPINTERFERENCE_TOOLOUD', 'SRTEmulated',
    'WAVEFORMATEX', 'SVP_16', 'DISPID_SPEs_NewEnum',
    'SPRST_INACTIVE_WITH_PURGE', 'SAFT24kHz8BitStereo',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SABufferNotifySize', 'ISpeechRecognizerStatus',
    'ISpeechMMSysAudio', 'SPSModifier', 'ISpSerializeState',
    'SpeechGrammarWordType', 'SAFTADPCM_44kHzStereo',
    'SPEI_PROPERTY_STRING_CHANGE', 'SVP_21',
    'SAFTCCITT_ALaw_11kHzMono', 'SBOPause', 'SpeechRuleAttributes',
    'DISPID_SPEsItem', 'SPEI_VISEME', 'DISPID_SCSBaseStream',
    'SAFTTrueSpeech_8kHz1BitMono', 'ISpRecoResult',
    'SAFT11kHz8BitMono', 'DISPID_SpeechPhraseProperties',
    'DISPID_SGRSTType', 'ISpLexicon', 'SPEI_END_SR_STREAM',
    'SPEI_RESERVED3', 'SpeechCategoryAudioIn',
    'ISpeechPhraseReplacement', 'SPLO_STATIC',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SpeechRecoContextEvents',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'eLEXTYPE_PRIVATE11',
    'SREAdaptation', 'ISpeechXMLRecoResult', 'SP_VISEME_20',
    'IInternetSecurityMgrSite', 'DISPID_SPEActualConfidence',
    'DISPID_SPPFirstElement', 'DISPID_SLWWord',
    'SpeechDictationTopicSpelling', 'SPEI_RECO_OTHER_CONTEXT',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SPXRO_SML', 'SDTRule',
    'ISpeechAudioBufferInfo', 'tagSPPROPERTYINFO', 'SRTAutopause',
    'DISPID_SABIBufferSize', 'DISPID_SGRSTPropertyId',
    'SPEI_HYPOTHESIS', 'DISPID_SVRate', 'SP_VISEME_11',
    'DISPID_SRCCreateGrammar', 'SPCS_DISABLED', 'SpVoice',
    'SPEI_SENTENCE_BOUNDARY', 'SpeechVoiceCategoryTTSRate',
    'SREHypothesis', 'ISpeechPhraseRule', 'DISPID_SpeechRecoContext',
    'SDTPronunciation', 'SRSEIsSpeaking', 'DISPID_SVPause',
    'DISPID_SRCCreateResultFromMemory', 'SPWORDPRONUNCIATION',
    'ISpStream', 'DISPID_SLWType', 'SpMMAudioEnum',
    'DISPID_SpeechLexiconWords', 'DISPID_SpeechRecoResultTimes',
    'ISpeechAudioFormat', 'SPDKL_CurrentUser', 'DISPID_SAFGuid',
    'DISPID_SpeechPhoneConverter', 'SPRST_NUM_STATES', 'SPVPRI_ALERT',
    'SSFMOpenForRead', 'SAFTGSM610_22kHzMono', 'ISequentialStream',
    'DISPID_SOTDataKey', 'SPDKL_LocalMachine', 'DISPID_SMSAMMHandle',
    'SPSVerb', 'UINT_PTR', 'DISPID_SPEAudioStreamOffset',
    'DISPID_SBSRead', 'DISPID_SRSetPropertyString',
    'SAFTGSM610_11kHzMono', 'SpeechCategoryAppLexicons',
    'DISPID_SPEAudioSizeBytes', 'SpeechAudioFormatType',
    'DISPID_SOTsItem',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SOTMatchesAttributes', 'DISPID_SPAsCount',
    'eLEXTYPE_RESERVED10', 'SpeechPropertyHighConfidenceThreshold',
    'SVPAlert', 'SPPS_RESERVED1', 'SAFTCCITT_uLaw_8kHzStereo',
    'SPPS_Noun', 'DISPID_SRGSetTextSelection',
    'SpeechPropertyComplexResponseSpeed', 'SLOStatic',
    'SPEI_SR_AUDIO_LEVEL', 'SPEI_SR_PRIVATE',
    'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'DISPID_SRRDiscardResultInfo', 'SPSEMANTICERRORINFO',
    'SRAORetainAudio', '_ISpeechRecoContextEvents',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SWFEChannels', 'SVP_20', 'SDTLexicalForm',
    'SpeechTokenKeyUI', 'DISPID_SGRsAdd', 'ISpeechPhraseProperties',
    'SAFTADPCM_11kHzMono', 'ISpeechRecoResult', 'SREStreamEnd',
    'SGDSActiveWithAutoPause', 'SFTSREngine', 'SGRSTTWildcard',
    'DISPID_SRGCmdSetRuleIdState', 'SVP_6',
    'DISPID_SOTRemoveStorageFileName', 'SRAInterpreter',
    'SGRSTTEpsilon', 'DISPID_SOTGetDescription', 'SRCS_Disabled',
    'SPPS_RESERVED2', 'DISPID_SAFSetWaveFormatEx',
    'SpeechEngineProperties', 'DISPID_SRGId', 'ISpeechObjectTokens',
    'DISPID_SVVoice', 'DISPID_SDKOpenKey', 'DISPID_SLWs_NewEnum',
    'SPEI_RESERVED1', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'DISPID_SGRsCount', 'DISPID_SRGRecoContext',
    'DISPID_SRCERequestUI', 'DISPID_SRRSpeakAudio',
    'SpPhraseInfoBuilder', 'SpAudioFormat', 'SLTUser', 'SRSActive',
    'SREPrivate', 'DISPID_SRRAlternates', 'STCInprocHandler',
    'SAFT12kHz16BitMono', 'SPSHT_EMAIL', 'ISpRecoCategory',
    'SpeechTokenKeyFiles', 'SVF_Emphasis', 'ISpRecoGrammar',
    'DISPID_SpeechAudioFormat', 'SPSHT_NotOverriden',
    'ISpNotifySource', 'DISPID_SpeechLexiconWord',
    'DISPID_SpeechLexiconProns', 'SWPUnknownWordPronounceable',
    'DISPID_SRCEBookmark', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'DISPID_SVVolume', 'SECFIgnoreKanaType', 'DISPID_SPCIdToPhone',
    'DISPID_SABIMinNotification', 'DISPID_SVSRunningState',
    'SAFT22kHz8BitMono', 'SPINTERFERENCE_NOSIGNAL',
    'DISPID_SVSLastResult', 'ISpeechVoiceStatus', 'SAFTText',
    'DISPID_SRRRecoContext', 'DISPID_SRAudioInputStream',
    'DISPID_SpeechDataKey', 'DISPID_SRGRules', 'SpMMAudioOut',
    'eLEXTYPE_PRIVATE2', 'DISPID_SRGCmdSetRuleState',
    'SPADAPTATIONRELEVANCE', 'SPEI_TTS_BOOKMARK',
    'DISPID_SpeechPhraseBuilder', 'SAFT48kHz16BitStereo',
    'DISPID_SGRSAddWordTransition', 'SAFT44kHz16BitMono',
    'SP_VISEME_5', 'SpNotifyTranslator', 'SP_VISEME_2',
    'SpResourceManager', 'SPPARTOFSPEECH',
    'DISPID_SpeechPhraseAlternate', 'ISpObjectWithToken',
    'DISPID_SPIEngineId', 'SDTAlternates', 'SVSFParseSsml',
    'DISPID_SRCEPropertyNumberChange', 'SPBO_AHEAD', 'DISPID_SVSkip',
    'SPRS_ACTIVE_USER_DELIMITED', 'SPRULESTATE', 'SGSEnabled',
    'SPPHRASEPROPERTY', 'SAFTNonStandardFormat',
    'DISPIDSPTSI_SelectionLength', 'SAFT44kHz8BitStereo',
    'SpCustomStream', 'SpeechAddRemoveWord',
    'ISpeechObjectTokenCategory',
    'SpeechPropertyLowConfidenceThreshold', 'SP_VISEME_19',
    'DISPID_SPILanguageId', 'DISPID_SpeechCustomStream',
    'ISpeechRecoResultTimes', 'DISPID_SABIEventBias',
    'SAFT24kHz16BitStereo', 'ISpeechObjectToken', 'SPAS_PAUSE',
    'SPINTERFERENCE_NONE', 'SDKLCurrentConfig', 'SVEAllEvents',
    'DISPID_SPCPhoneToId', 'SRAImport', 'eLEXTYPE_PRIVATE5',
    'SPFM_CREATE', 'DISPID_SPAPhraseInfo', 'SPWF_INPUT',
    'DISPID_SGRSTWeight', 'SpWaveFormatEx', 'DISPID_SBSWrite',
    'SpeechInterference', 'SPWORDLIST', 'SPWORDPRONOUNCEABLE',
    'SPGS_EXCLUSIVE', 'SPWORDPRONUNCIATIONLIST', 'DISPID_SGRsItem',
    'DISPIDSPTSI_ActiveOffset', 'ISpPhoneticAlphabetConverter',
    'SVEEndInputStream', 'DISPID_SMSGetData', 'DISPID_SPIProperties',
    'ISpEventSource', 'STCRemoteServer', 'DISPID_SWFEAvgBytesPerSec',
    'SPDATAKEYLOCATION', 'ISpDataKey', 'DISPID_SRCVoicePurgeEvent',
    'DISPID_SLWsItem', 'SVP_8', 'DISPID_SPRNumberOfElements',
    'DISPID_SVEEnginePrivate', 'SRESoundStart', 'DISPID_SPIRule',
    'DISPID_SpeechPhraseElements', 'SREPhraseStart',
    'DISPID_SRCResume', 'DISPID_SpeechFileStream',
    'DISPID_SpeechPhraseRules', 'SP_VISEME_0',
    'DISPID_SRCEFalseRecognition', 'DISPID_SpeechVoice',
    'DISPID_SVESentenceBoundary', 'SPCONTEXTSTATE',
    'DISPID_SRGIsPronounceable', 'SpObjectToken',
    'DISPID_SRCSetAdaptationData', 'SPRS_INACTIVE',
    'DISPID_SRCAudioInInterferenceStatus', 'DISPID_SVAlertBoundary',
    'SpeechVoiceSpeakFlags', 'SVESentenceBoundary',
    'eLEXTYPE_PRIVATE8', 'SpeechVisemeType',
    'SpeechEmulationCompareFlags', 'SpeechPartOfSpeech',
    'DISPID_SABufferInfo', 'STCLocalServer', 'DISPID_SOTSetId',
    'DISPID_SDKGetStringValue', 'SPEI_ADAPTATION', 'SPSNotOverriden',
    'DISPID_SASState', 'DISPID_SGRSTsItem', 'DISPID_SVIsUISupported',
    'eLEXTYPE_PRIVATE20', 'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SRSClsidEngine', 'DISPID_SPIReplacements',
    'eWORDTYPE_ADDED', 'SpeechPropertyResourceUsage',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SRRTOffsetFromStart', 'DISPID_SDKGetBinaryValue',
    'SWPKnownWordPronounceable', 'ISpeechGrammarRuleState',
    'ISpStreamFormat', 'SRARoot', 'SPAUDIOSTATE', 'SWTDeleted',
    'eLEXTYPE_MORPHOLOGY', 'SGDSActive', 'SPRST_ACTIVE', 'SPAO_NONE',
    'DISPID_SASFreeBufferSpace', 'eLEXTYPE_LETTERTOSOUND',
    'SPSTREAMFORMATTYPE', 'DISPID_SPIAudioSizeBytes',
    'SpeechPropertyAdaptationOn', 'DISPID_SRCRecognizer',
    'SpeechTokenContext', 'SVSFPersistXML', 'SGSExclusive',
    'DISPID_SRStatus', '__MIDL_IWinTypes_0009',
    'DISPID_SpeechLexiconPronunciation', '_ISpeechVoiceEvents',
    'SpeechRecoEvents', 'SVSFIsNotXML', 'SPEI_SOUND_START',
    'SP_VISEME_16', 'DISPID_SPPs_NewEnum',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SDKCreateKey',
    'SPGS_ENABLED', 'ISpeechAudioStatus', 'SAFT16kHz8BitMono',
    'DISPID_SRIsUISupported', 'ISpStreamFormatConverter',
    'SpeechLexiconType', 'SpObjectTokenCategory',
    'SpeechUserTraining', 'SpMMAudioIn', 'SPLO_DYNAMIC',
    'SPSHORTCUTTYPE', 'SGRSTTTextBuffer',
    'DISPID_SPPNumberOfElements', 'SASClosed',
    'SpeechRecognitionType', 'SRSInactiveWithPurge',
    'SPSHORTCUTPAIRLIST', 'DISPID_SOTsCount',
    'DISPID_SPRules_NewEnum', 'ISpResourceManager',
    'SPSEMANTICFORMAT', 'eLEXTYPE_PRIVATE4', 'SECFNoSpecialChars',
    'SREBookmark', 'DISPID_SRIsShared', 'SPPS_Unknown',
    'SVSFParseAutodetect', 'DISPID_SRSCurrentStreamPosition',
    'DISPID_SLAddPronunciation', 'DISPID_SRGDictationSetState',
    'SP_VISEME_6', 'SpUnCompressedLexicon', 'SITooQuiet',
    'ISpShortcut', 'DISPID_SVResume', 'SDA_Two_Trailing_Spaces',
    'SPBO_TIME_UNITS', 'SGDSActiveUserDelimited', 'SP_VISEME_15',
    'DISPID_SPRText', 'DISPID_SPRuleParent', 'SPDKL_DefaultLocation',
    'DISPID_SGRSTRule', 'SpeechVisemeFeature', 'SAFT8kHz16BitMono',
    'ISpeechGrammarRule', 'DISPID_SGRSTText',
    'DISPID_SpeechRecoResult2', 'SPCT_COMMAND',
    'SpeechRetainedAudioOptions', 'DISPID_SOTCategory',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SREInterference',
    'SPCS_ENABLED', 'DISPID_SFSClose', 'DISPID_SRCreateRecoContext',
    'ISpeechMemoryStream', 'DISPID_SRRecognizer',
    'DISPID_SVEVoiceChange', 'SAFTCCITT_uLaw_11kHzMono',
    'SpeechBookmarkOptions', 'SVF_None', 'SpCompressedLexicon',
    'SPAR_Medium', 'SRTStandard', 'SAFT12kHz8BitMono',
    'DISPID_SRRAudio', 'Speech_Max_Pron_Length', 'SPCT_DICTATION',
    'DISPID_SpeechRecoResult', 'SGDisplay', 'DISPID_SASNonBlockingIO',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SOTDisplayUI',
    'tagSTATSTG', 'DISPID_SpeechPhraseRule', 'DISPID_SRCBookmark',
    'SpeechAllElements', 'SVSFNLPMask', 'ISpeechLexicon',
    'SPAO_RETAIN_AUDIO', 'DISPID_SLRemovePronunciation',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SDKSetBinaryValue',
    'SECHighConfidence', 'SVEBookmark', 'SRTSMLTimeout', 'SASStop',
    'SAFT22kHz8BitStereo', 'eLEXTYPE_PRIVATE10', 'ISpMMSysAudio',
    'DISPID_SAVolume', 'SDKLCurrentUser', 'SPINTERFERENCE_TOOSLOW',
    'DISPID_SPEsCount', 'SREAllEvents', 'ISpeechLexiconPronunciation',
    'DISPID_SpeechPhraseProperty', 'SAFTADPCM_22kHzStereo',
    'SpeechRecognizerState', 'eLEXTYPE_PRIVATE14', 'SINone',
    'DISPID_SpeechPhraseAlternates', 'SPEI_MAX_SR', 'SPAS_RUN',
    'SPPS_SuppressWord', 'DISPID_SAFType', 'DISPID_SPRuleId',
    'SAFT44kHz8BitMono', 'ISpeechPhraseInfo', 'DISPID_SVEPhoneme',
    'ISpeechRecoContext', 'DISPID_SpeechObjectToken',
    'SPDKL_CurrentConfig', 'SpeechAudioFormatGUIDText',
    'SPWT_DISPLAY', 'SpeechRuleState', 'SINoSignal',
    'DISPID_SpeechBaseStream', 'SRADefaultToActive',
    'SAFT8kHz8BitStereo', 'SAFTADPCM_8kHzMono', 'DISPID_SGRsDynamic',
    'SPRECOCONTEXTSTATUS', 'ISpeechLexiconWord', 'SVP_7',
    'SSSPTRelativeToEnd', 'STSF_CommonAppData', 'SPEVENTSOURCEINFO',
    'SVP_1', 'ISpeechGrammarRuleStateTransition',
    'eLEXTYPE_PRIVATE17', 'DISPID_SPRuleFirstElement',
    'DISPID_SPPChildren', 'SPSHORTCUTPAIR', 'SPEVENTENUM',
    'DISPID_SVSLastBookmark', 'SVP_5', 'SRSActiveAlways',
    'SpeechCategoryRecognizers', 'DISPID_SPEAudioSizeTime',
    'SpeechFormatType', 'DISPID_SPIGetText', 'ISpeechDataKey',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SGRSTs_NewEnum',
    'DISPID_SPRDisplayAttributes', 'ISpeechPhraseElements',
    'DISPID_SPPValue', 'ISpPhrase', 'DISPID_SOTCId',
    'DISPID_SRCState', 'DISPID_SLAddPronunciationByPhoneIds',
    'SPEI_RECOGNITION', 'DISPID_SPELexicalForm', 'SGRSTTRule',
    'SRTExtendableParse', 'SAFTCCITT_ALaw_11kHzStereo',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SVP_9', 'DISPID_SGRSTsCount',
    'SPEI_INTERFERENCE', 'SPFM_OPEN_READWRITE', 'SPEI_VOICE_CHANGE',
    'DISPID_SOTGetAttribute', 'DISPID_SRRTTickCount', 'ISpAudio',
    'DISPID_SLPPartOfSpeech', 'SGRSTTDictation',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SRGCmdLoadFromResource',
    'SPSERIALIZEDPHRASE', 'DISPID_SRGSetWordSequenceData',
    'DISPID_SBSFormat', 'SDTProperty', 'DISPID_SPRulesCount',
    'DISPID_SPERetainedSizeBytes', 'DISPID_SpeechPhraseReplacement',
    'SPSHT_Unknown', 'SVF_Stressed', 'DISPID_SDKSetStringValue',
    'DISPID_SPPId', 'SpInProcRecoContext', 'SPRULE',
    'SpeechRegistryLocalMachineRoot', 'SRERecoOtherContext',
    'ISpeechPhraseAlternates', 'DISPID_SRRTStreamTime', 'SRSInactive',
    'SAFT16kHz8BitStereo', 'SPRECOSTATE', 'SPPS_Noncontent',
    'SPPHRASEELEMENT', 'SAFT12kHz8BitStereo', 'SAFTADPCM_44kHzMono',
    'SP_VISEME_12', 'DISPID_SVSpeakStream', 'DISPID_SDKEnumValues',
    'SPWAVEFORMATTYPE', 'SP_VISEME_9', 'DISPID_SGRSRule', 'SVP_19',
    'DISPID_SDKDeleteValue', 'SPEI_FALSE_RECOGNITION',
    'DISPID_SRSSupportedLanguages', 'SPRECOGNIZERSTATUS',
    'SSFMCreate', 'DISPID_SVSCurrentStreamNumber',
    'eLEXTYPE_RESERVED6', 'eLEXTYPE_PRIVATE15',
    'DISPID_SOTIsUISupported', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'ISpeechPhraseAlternate', 'DISPID_SPERetainedStreamOffset',
    'DISPID_SPAStartElementInResult', 'SpeechCategoryAudioOut',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'SpeechGrammarRuleStateTransitionType', 'ISpRecognizer3',
    'SpNullPhoneConverter', 'SpeechAudioProperties',
    'ISpPhoneticAlphabetSelection', 'DISPID_SGRClear',
    'SSFMCreateForWrite', 'SPEVENT', 'SAFTNoAssignedFormat',
    'SpeechTokenIdUserLexicon', 'SAFT22kHz16BitStereo',
    'DISPID_SRCEEndStream', 'SAFTCCITT_uLaw_44kHzMono',
    'ISpNotifySink', 'SpFileStream', 'DISPID_SVAudioOutput',
    'DISPID_SRCERecognizerStateChange', 'DISPID_SRCEAudioLevel',
    'SPSLMA', 'SAFT11kHz16BitMono', 'ISpeechVoice', 'SPVOICESTATUS',
    'SPEI_RESERVED6', 'SPEI_MIN_TTS', 'DISPID_SWFEFormatTag',
    'SpeechStreamSeekPositionType', 'SITooFast',
    'SpeechPropertyResponseSpeed', 'SVP_17',
    'DISPID_SPIAudioSizeTime', 'DISPID_SGRSTransitions', 'SRAExport',
    'SpeechDataKeyLocation', 'DISPID_SRCRetainedAudioFormat',
    'SDTDisplayText', 'DISPID_SLWsCount', 'DISPID_SRAudioInput',
    'SPSUnknown', 'ISpeechRecoResultDispatch', 'ISpRecognizer2',
    'SPEI_RESERVED5', 'DISPID_SRRTLength', 'SAFT48kHz16BitMono',
    'ISpeechResourceLoader', 'SPPHRASERULE', 'SVP_14',
    'SAFTExtendedAudioFormat', 'SVP_11', 'SPINTERFERENCE_TOOQUIET',
    'SPEI_TTS_PRIVATE', 'SpeechRunState',
    'DISPID_SpeechPhraseReplacements', 'DISPID_SRGetRecognizers',
    'DISPID_SRGetPropertyNumber', 'DISPID_SPIStartTime',
    'SP_VISEME_18', 'DISPID_SVStatus', 'DISPID_SVSPhonemeId',
    'eLEXTYPE_RESERVED8', 'SPEI_START_INPUT_STREAM',
    'DISPID_SpeechAudio', 'SPBO_NONE', 'ISpeechPhraseRules',
    'DISPIDSPTSI', 'DISPID_SRCPause', 'SPFM_NUM_MODES',
    'DISPID_SVAudioOutputStream', 'DISPID_SRRPhraseInfo',
    'DISPID_SVEWord', 'DISPID_SLGetPronunciations',
    'SpeechDisplayAttributes', 'DISPID_SVWaitUntilDone', 'SpShortcut',
    'DISPID_SRRGetXMLResult', 'SGSDisabled',
    'SDA_Consume_Leading_Spaces', 'SpeechEngineConfidence',
    'DISPID_SLGetWords', 'ISpeechRecoResult2', 'SPRST_ACTIVE_ALWAYS',
    'DISPID_SRCRetainedAudio', 'SGLexicalNoSpecialChars',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SDKDeleteKey',
    'SPINTERFERENCE_TOOFAST', 'DISPID_SBSSeek',
    'SAFT11kHz16BitStereo', 'SP_VISEME_4', 'DISPIDSPRG', 'SRAONone',
    'STSF_LocalAppData', 'DISPID_SOTCSetId', 'SVSFVoiceMask',
    'SAFT24kHz8BitMono', 'DISPID_SASCurrentSeekPosition',
    'eWORDTYPE_DELETED', 'SRCS_Enabled', 'DISPID_SpeechAudioStatus',
    'SPAR_High', 'SPEI_SR_BOOKMARK', 'DISPID_SVSInputWordLength',
    'SSTTWildcard', 'SPVPRIORITY', 'SP_VISEME_8', 'SPPS_Interjection',
    'SPXMLRESULTOPTIONS', 'SSTTDictation', 'ISpeechCustomStream',
    'eLEXTYPE_APP', 'SPBOOKMARKOPTIONS', 'SPEI_SOUND_END',
    'DISPID_SpeechRecognizer', 'DISPID_SPEDisplayAttributes',
    'SVEStartInputStream', 'DISPID_SRCEPhraseStart',
    'SPSMF_SAPI_PROPERTIES', 'SFTInput', 'SP_VISEME_10',
    'SAFTCCITT_ALaw_8kHzMono', 'SGLexical', 'SP_VISEME_14',
    'ISpObjectTokenCategory', 'SRERequestUI', 'DISPID_SLPsItem',
    'ISpeechPhraseProperty', 'ISpeechAudio', 'SVSFlagsAsync',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'DISPID_SVSpeakCompleteEvent',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SLPsCount',
    'DISPID_SPACommit', 'SPVISEMES', 'DISPID_SRCEAdaptation',
    'STSF_FlagCreate', 'SPINTERFERENCE_NOISE', 'SP_VISEME_21',
    'DISPID_SpeechGrammarRule', 'SRADynamic', 'SECFIgnoreCase',
    'SDTAll', 'ISpeechLexiconWords',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SGRSTPropertyValue', 'SpeechVoiceSkipTypeSentence',
    'SECFDefault', 'ISpEventSink', 'SVP_2',
    'DISPID_SpeechObjectTokens', 'ISpeechPhraseElement',
    'DISPID_SDKEnumKeys', 'SPEI_PHONEME',
    'DISPID_SLGetGenerationChange', 'SPAR_Low', 'SVSFDefault',
    'SPWF_SRENGINE', 'SPBO_PAUSE', 'DISPIDSPTSI_SelectionOffset',
    'SPPS_RESERVED4', 'ISpPhoneConverter', 'DISPID_SPPsCount',
    'SPGRAMMARSTATE', 'DISPID_SpeechPhraseElement',
    'SAFTCCITT_uLaw_22kHzMono', 'SAFT44kHz16BitStereo',
    'SpeechAudioVolume', 'eLEXTYPE_PRIVATE12', 'SPAUDIOOPTIONS',
    'SpeechStreamFileMode', 'SBONone', 'SVEAudioLevel',
    'DISPID_SRGDictationLoad', 'SASRun', 'SREStreamStart',
    'Speech_StreamPos_Asap', 'DISPID_SPAsItem', 'SECFEmulateResult',
    'DISPID_SPARecoResult', 'DISPID_SPIEnginePrivateData',
    'SpeechDiscardType', 'ISpGrammarBuilder', 'STCAll',
    'DISPID_SGRName', 'DISPID_SGRSAddRuleTransition',
    'eLEXTYPE_PRIVATE7', 'SPWT_LEXICAL', 'eLEXTYPE_PRIVATE19',
    'DISPIDSPTSI_ActiveLength', 'DISPID_SRCEInterference',
    'SpeechGrammarTagWildcard', 'SPEI_RESERVED2',
    'eLEXTYPE_PRIVATE16', 'ISpeechPhraseReplacements',
    'DISPID_SPIAudioStreamPosition', 'IInternetSecurityManager',
    'eLEXTYPE_RESERVED4', 'SpeechAudioFormatGUIDWave',
    'DISPID_SPIGrammarId', 'IEnumSpObjectTokens', 'SPPS_RESERVED3',
    'SVEVoiceChange', 'DISPID_SRRSetTextFeedback', 'SDTReplacement',
    'DISPID_SDKGetlongValue', 'DISPID_SOTCreateInstance',
    'DISPID_SpeechGrammarRules', 'DISPID_SGRSTNextState',
    'Speech_Default_Weight', 'SLODynamic', 'SPAUDIOSTATUS',
    'DISPID_SOTs_NewEnum', 'DISPID_SPRuleChildren',
    'SpeechCategoryVoices', 'SPPHRASEREPLACEMENT',
    'DISPID_SVGetAudioInputs', 'DISPID_SRGReset', 'ISpXMLRecoResult',
    'DISPID_SASetState', 'DISPID_SpeechAudioBufferInfo',
    'DISPID_SVSInputSentenceLength', 'ISpeechRecognizer',
    'DISPID_SGRAddResource', 'SPEI_WORD_BOUNDARY', 'DISPID_SRCVoice',
    'DISPID_SLPType', 'DISPID_SOTRemove', 'DISPID_SLGenerationId',
    'SREPropertyNumChange', 'DISPID_SRGCmdLoadFromObject',
    'SPSInterjection', 'DISPID_SGRsFindRule', 'SPSERIALIZEDRESULT',
    'DISPID_SMSADeviceId', 'SPCATEGORYTYPE',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SAFGetWaveFormatEx',
    'SVSFParseSapi', 'SRTReSent', 'DISPID_SVSpeak',
    'DISPID_SpeechMMSysAudio', 'DISPID_SGRSTPropertyName',
    'SpMemoryStream', 'DISPID_SRRTimes', 'SVP_12', 'SITooSlow',
    'DISPID_SOTCDefault', 'SPEI_END_INPUT_STREAM',
    'DISPID_SGRInitialState', 'SPAR_Unknown', 'SPWT_PRONUNCIATION',
    'DISPID_SVSVisemeId', 'SPLOADOPTIONS', 'DISPID_SMSSetData',
    'DISPID_SRGCommit', 'DISPID_SWFESamplesPerSec',
    'DISPID_SPEDisplayText', 'SpPhoneConverter',
    'ISpeechGrammarRules', 'ISpeechLexiconPronunciations',
    'DISPID_SRSNumberOfActiveRules', 'SECLowConfidence',
    'SRERecognition', 'DISPID_SVSLastStreamNumberQueued',
    'DISPID_SADefaultFormat', 'DISPID_SREmulateRecognition',
    'SAFT22kHz16BitMono', 'SAFT32kHz16BitMono',
    'SpeechRecoProfileProperties', 'SpInprocRecognizer', 'SPWORDTYPE',
    'SPAS_STOP', 'DISPID_SRGetFormat', 'SpSharedRecognizer',
    'ISpRecognizer', 'SPSHT_OTHER', 'STCInprocServer',
    'SpTextSelectionInformation', 'DISPID_SPRsItem', 'SDTAudio',
    'SDKLDefaultLocation', 'ISpRecoGrammar2', 'SPVPRI_NORMAL',
    'SVP_18', 'DISPID_SOTGetStorageFileName', 'SPPS_LMA',
    'SWPUnknownWordUnpronounceable', 'SAFTADPCM_22kHzMono',
    'SpeechMicTraining', 'SPGRAMMARWORDTYPE', 'eLEXTYPE_USER',
    'DISPID_SOTCGetDataKey', 'SSSPTRelativeToStart',
    'DISPID_SAEventHandle', 'SPPS_NotOverriden', 'DISPID_SPPParent',
    'eLEXTYPE_PRIVATE3', 'eLEXTYPE_PRIVATE13', 'LONG_PTR',
    'SDA_No_Trailing_Space', 'DISPID_SGRsCommit',
    'SPTEXTSELECTIONINFO', 'DISPID_SRRGetXMLErrorInfo',
    'DISPID_SpeechLexicon', 'DISPID_SRCRequestedUIType',
    'DISPID_SRCEventInterests', 'SSFMOpenReadWrite', 'SPSNoun',
    ...
    'DISPID_SPRsCount', 'DISPID_SLPLangId', 'DISPID_SRCEStartStream',
    'DISPID_SLPs_NewEnum', 'DISPID_SVSInputWordPosition',
    'ISpeechPhraseInfoBuilder', 'DISPID_SPANumberOfElementsInResult',
    'SVPNormal', 'SpeechSpecialTransitionType', 'DISPID_SOTId',
    'SPPHRASE', 'SPSSuppressWord', '_SPAUDIOSTATE', 'SPGS_DISABLED',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SpLexicon',
    'ISpObjectToken', 'DISPID_SPPConfidence', 'SAFT16kHz16BitStereo',
    'SAFTCCITT_uLaw_11kHzStereo', 'SAFT32kHz8BitStereo',
    'DISPID_SRGetPropertyString', 'SAFT32kHz16BitStereo',
    'DISPID_SVSLastBookmarkId', 'SpeechAudioState',
    'SAFT11kHz8BitStereo', 'SP_VISEME_13', 'SpeechTokenKeyAttributes',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SPCLangId', 'SINoise',
    'SPWORD', 'DISPID_SRCESoundEnd', 'SWTAdded',
    'DISPID_SRGCmdLoadFromFile', 'eLEXTYPE_PRIVATE6', 'SVP_13',
    'SPINTERFERENCE', 'DISPID_SRCERecognition', 'SAFT32kHz8BitMono',
    'SpPhoneticAlphabetConverter', 'DISPID_SVGetVoices', 'SPSMF_UPS',
    'DISPID_SVEStreamStart', 'DISPID_SPIGetDisplayAttributes',
    'SVSFPurgeBeforeSpeak', 'SPEI_RECO_STATE_CHANGE',
    'DISPID_SLWPronunciations', 'SPPS_Modifier', 'DISPID_SPRulesItem',
    'DISPID_SWFEBlockAlign', 'DISPID_SPAs_NewEnum',
    'DISPID_SRDisplayUI', 'SPPROPERTYINFO', 'SPEI_MAX_TTS',
    'DISPID_SRGDictationUnload', 'DISPID_SVEViseme',
    'DISPID_SpeechMemoryStream', 'SVEViseme',
    'Speech_Max_Word_Length', 'SVSFNLPSpeakPunc'
]

_check_version('1.2.0', 1618046272.285496)
